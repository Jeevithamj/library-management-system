...
int main() {
    ...
    cout <<endl<<"Developed By\n"<<endl<<"Name: Jeevitha MJ"<<endl<<"USN: 4GM20IS024"<<"\n\n"<<"Name: Hemashree CS"<<endl<<"USN: 4GM20IS022"<<"\n\n"<<"Name: Kavana GH"<<endl<<"USN: 4GM20IS025"<<"\n\n"<<"Name: Jahnavi HS"<<endl<<"USN: 4GM20IS023"<<"\n\n";
            ...
            case 2: {
                ...
                if (choise == 0) break;
                    ...
                    getline(cin, author_name);
                     int id = generateBookID(author_name);
                // For each rack
               		 for (int c = 0; c < 5; ++c) 
					{
                    // For shelve
                    ...
                    if (bst != nullptr) 
					{
                        found = SearchingsearchBook(bst, author_name, c, shelve);
                        break;
               		}
               	}
               	int shelve = id % 10;
               	cout<<"record at shelve\n"<<shelve;
               }
                break;
            }
...
void generateLibraryData() {
    ifstream inFile;
    inFile.open("E:\\Library-Management-System-master\\Library-Management-System-master\\datafile.txt");
    if (!inFile) {
